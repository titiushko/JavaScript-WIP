...
*/
    ...
    */
	...
	__AutoCompleteComboBox = new Array();
	...
	function ChangeUp (id) {
		...
		document.getElementById(id).src = "btnUp.JPG";
    ...
    */
    function AutoComplete_Create (id, id2, data)
    {        
		...
		document.getElementById(id2).onclick = function(e) {AutoComplete_ShowDropdown(document.getElementById(id).getAttribute('id'));if (!e) e = window.event; e.cancelBubble = true; e.returnValue = false;document.getElementById(id2).src = "btnDown.jpg";}
